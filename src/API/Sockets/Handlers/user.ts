 ...
 * Прим:
 *
 * Если А был подписан на Б, и Б вызвал add_relation для А, то они станут друзьями
 ...
 * Прим:
 *
 * Если А был подписан на Б, и А вызвал drop_relation для Б, то A отпишется от Б

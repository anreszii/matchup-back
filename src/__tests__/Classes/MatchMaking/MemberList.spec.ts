...
describe('Member List', () => {
  let list: MemberList
  const TEAM_1: Array<Match.Member.Instance> = [
  ...
  const TEAM_2: Array<Match.Member.Instance> = [
  ...
  const TEAM_NEUTRAL: Array<Match.Member.Instance> = [
  ...
  const SPECTATORS: Array<Match.Member.Instance> = [
